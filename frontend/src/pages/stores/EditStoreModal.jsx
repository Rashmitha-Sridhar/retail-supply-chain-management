...
const EditStoreModal = ({ store, warehouses, onClose, reload }) => {
      ...
      <div className="bg-base-100 p-6 rounded-xl shadow-xl w-full max-w-lg">
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          ...
          <div>
            ...
            {touched.warehouse_id && errors.warehouse_id && (
              <p className="text-red-500 text-sm">{errors.warehouse_id}</p>
            )}
          </div>
          ...
          <div>
            ...
            />
            {touched.manager_name && errors.manager_name && (
              <p className="text-red-500 text-sm">{errors.manager_name}</p>
            )}
          </div>
          ...
          <div className="flex justify-end gap-2 pt-2">
            ...
            <button className="btn btn-purple" disabled={!isValid || loading}>
              {loading ? <span className="loading loading-sm loading-spinner"></span> : "Save Changes"}
            </button>
          </div>
